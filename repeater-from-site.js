...
(function (factory) {
    ...
    function getit(cityOrZip, distance, allData = [], fileName, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield getListTables(dom, cityOrZip, allData, fileName);
            if (limit) {
    ...
    function getListTables(dom, cityOrZip, allData, fileName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const table of tables) {
                yield getTableRows(table, cityOrZip, allData, fileName);
            }
        });
    }
    function getTableRows(table, cityOrZip, allData, fileName) {
        return __awaiter(this, void 0, void 0, function* () {
            // console.log('getTableRows', table);
            const rows = [...table.querySelectorAll('tbody > tr')];
            for (const row of rows) {
                yield getRowCells(row, cityOrZip, allData, fileName);
            }
        });
    }
    function getRowCells(row, cityOrZip, allData, fileName) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!row) {
                return;
            }
            ...
            if (first) {
                ...
                if (anchor) {
                    ...
                    yield getNewPage(href, distance, cityOrZip, allData, fileName);
                }
            }
        });
    }
    function getNewPage(href, distance, cityOrZip, allData, fileName) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log();
    ...
    function start() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield getit('Colorado Springs, CO', 100, totalRepeaters, 'cos-den', 200 - 56);
            yield getit('Denver, CO', 100, totalRepeaters, 'cos-den', 200 - 56);
            yield getit('Colorado Springs, CO', 100, totalRepeaters, 'cos-den', 128 - 56);
            yield getit('Denver, CO', 100, totalRepeaters, 'cos-den', 128 - 56);
        });
    }
