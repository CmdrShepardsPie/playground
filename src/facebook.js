...
async function changeTimeline(row) {
    ...
    if (edit) {
        ...
        if (menu) {
            const allMenuItems = Array.prototype.slice.apply(menu.querySelectorAll(`[role="menu"] [role="presentation"] a`));
        ...
        setTimeout(() => {
            try {
                ...
                if (menu) {
                    ...
                    const allMenuItems = Array.prototype.slice.apply(menu.querySelectorAll(`*`));
        ...
        setTimeout(() => {
            try {
                ...
                if (dialog) {
                    ...
                    const allDialogItems = Array.prototype.slice.apply(dialog.querySelectorAll(`*`));
